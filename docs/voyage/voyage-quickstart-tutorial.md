...
When the number of document is huge, one will need to use a vector database (e.g. MongoDB Atlas) to compute (approximate) k-nearest neighbor efficiently, which is beyond the scope of this tutorial.
